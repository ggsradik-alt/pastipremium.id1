  ...
  return (
    <div style={{
        ...
        <section style={{ padding: '0 20px 40px', maxWidth: '1000px', margin: '0 auto' }}>
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '1px solid rgba(0,0,0,0.05)', paddingBottom: '16px' }}>
              <div>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 600, letterSpacing: '-0.01em', marginBottom: '4px' }}>{t('leaderboard_title')}</h3>
                <p style={{ fontSize: '0.85rem', color: C_TEXT_MUTED, margin: 0 }}>{t('leaderboard_subtitle')}</p>
              </div>
      ...
      <section id="katalog" style={{ padding: '0 20px 100px', maxWidth: '1200px', margin: '0 auto' }}>
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '60px 20px', color: C_TEXT_MUTED }}>
            <h3 style={{ fontWeight: 600, fontSize: '1.2rem', marginBottom: '8px', color: C_TEXT }}>{t('catalog_empty_title')}</h3>
            ...
            {!selectedCategory ? (
              ...
              >
                <div style={{ marginBottom: '32px', textAlign: 'center' }}>
                  ...
                  <p style={{ fontSize: '1rem', color: C_TEXT_MUTED }}>{t('categories_available', { count: categories.length })}</p>
                </div>
      ...
      <footer style={{
        ...
        {!isIDR && (
          <p style={{ fontSize: '0.72rem', color: C_TEXT_MUTED, margin: '6px 0 0', fontWeight: 400, opacity: 0.7 }}>
